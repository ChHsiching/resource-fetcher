...
class TestExtractFilenameFromHeaders:
    ...
    def test_extract_chinese_filename_with_mojibake(self):
        ...
        original = "圣哉三一歌.mp3"
        mojibake = original.encode("utf-8").decode("latin-1")
        headers = {"Content-Disposition": f'attachment; filename="{mojibake}"'}
    ...
    def test_extract_rfc5987_format(self):
        ...
        headers = {"Content-Disposition": "attachment; filename*=UTF-8''%E5%9C%A3%E5%93%89.mp3"}
    ...
    def test_fallback_to_song_id_and_title(self):
        ...
        result = extract_filename_from_headers(
            headers, song_id="16875", song_title="第1首 圣哉三一歌"
        )
    ...
    def test_fallback_to_title_only(self):
        ...
        headers = {}
        result = extract_filename_from_headers(headers, song_title="圣哉三一歌")
        assert result == "圣哉三一歌.mp3"

    def test_fallback_to_id_only(self):
        """Test fallback to ID only when no title provided."""
        headers = {}
        result = extract_filename_from_headers(headers, song_id="16875")
    ...
    def test_url_encoded_filename(self):
        ...
        headers = {"Content-Disposition": "attachment; filename*=UTF-8''test%20song.mp3"}
